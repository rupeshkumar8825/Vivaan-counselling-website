    ...
    return (
        <div className="flex justify-center items-center">
            <div className=" w-4/5 text-center text-white rounded-lg shadow sm:p-8 bg-gray-800 border-gray-700">
                <h5 className="mb-2 text-3xl font-bold">Admission and Councelling</h5>
...
const BoxModuleComponent = (props : IBoxModuleComponent) => {
    return (
        <div>
            <a href="#" className="w-full sm:w-auto bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5 bg-gray-700 hover:bg-gray-600 focus:ring-gray-700">
