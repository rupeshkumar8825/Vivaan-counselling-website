...
const TestimonialBoxComponent = () => {
    return (
        <div className="w-full md:w-1/3 ml-0 md:ml-10 mb-8 border border-gray-200 rounded-xl shadow-sm border-gray-700 md:mb-12 bg-gray-800">
