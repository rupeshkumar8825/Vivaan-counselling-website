...
export const JeeMainContentList : Array<string> = [
    `• The IIT-JEE (Indian Institutes of Technology Joint Entrance Examination) was first conducted in 1961. It was an entrance examination in India for admission to various undergraduate programs in engineering and technology at the prestigious Indian Institutes of Technology (IITs) and other participating institutions.\n
     ...
     • From 2019 onwards Jee Main is conducted by NTA and Jee Advance is conducted by IIT`,
    `The JEE Main exam is administered and conducted by the authority known as the National Testing Agency (NTA). NTA is the agency responsible for conducting the JEE Main every year in two shfit first in january and second in april. NTA is conducting jee main exam since 2019 onwards`,
    ...
    `<strong> 1. Latest Announcement: </strong>\n
    ...
    <strong> 2. Organizer: </strong>\n
    Since 2019, National Testing Agency (NTA)\n
    <strong> 3. Purpose: </strong>\n
    ...
    <strong> 4. Frequency: </strong>\n
    Twice in a year in January and April (Session-1 & Session-2).\n
    <strong>4. Mode of Exam:</strong> \n
    ...
    • <strong>Paper 2B (B. Planning):</stronger> Online mode`,
    `Every year jee main conduct exam in two phase and in each phase there are 75 question each 25 in physics ,chemistry and maths Paper is divided into two section ,section A and Section B Section A contains 20 question which are objective in nature Section B contains 5 question which are integer type Marking scheme for section A and B both are +4 and -1`,
    `Click here to download the cutoff of JEE Main 2025 <span style = "color : blue;"><a href="https://jeemain.nta.nic.in" target="_blank" rel="noopener noreferrer">Click here</a></span>`,
    ...
    <strong> List of Qualifying Exams: </strong>\n
    ...
    If a candidate has passed the Class XII (or equivalent) qualifying examination from one State but appeared for improvement from another State, the candidate's State code of eligibility will be from where the candidate first passed the Class XII (or equivalent) examination and NOT the State from where the candidate has appeared for improvement. Candidates passed / appearing for Class XII from NIOS should select the State of Eligibility according to the State in which the study Centre is located. For Indian nationals passing the Class XII (or equivalent) examination from Nepal/Bhutan, the State code of eligibility will be determined based on a permanent address in India as given in the passport of the candidate. The State code of eligibility for OCI passing the Class XII (or equivalent) examination in India is at par with Indian nationals. 
    ...
    `<span style = "color : blue;"><a href="https://jeemain.nta.nic.in" target="_blank" rel="noopener noreferrer">Click here</a></span> to download jee main latest syllabus`,
    `<span style = "color : blue;"><a href="https://jeemain.nta.nic.in" target="_blank" rel="noopener noreferrer">Click here</a></span> to download jee main latest result`,
    `<span style = "color : blue;"><a href="https://jeemain.nta.nic.in" target="_blank" rel="noopener noreferrer">Click here</a></span> to download jee main latest marks vs percentile`,
