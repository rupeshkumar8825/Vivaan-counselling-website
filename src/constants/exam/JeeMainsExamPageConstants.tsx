...
<span style = "color : white; font-weight: bold; font-size: larger;" class="underline"> 3. Purpose : </span>\n
...
<span style = "color : white; font-weight: bold; font-size: larger;" class="underline"> 4. Frequency: </span>\n
<span style = "font-weight: bold;">Twice in a year</span> in January and April (Session-1 & Session-2).\n
<span style = "color : white; font-weight: bold; font-size: larger;" class="underline"> 5. Mode of Exam: </span>\n
...
`To download the cutoff of JEE Main 2025 <span style = "color : white;" class="underline"><a href="https://JEEmain.nta.nic.in" target="_blank" rel="noopener noreferrer">Click here</a></span>`,
...
<span style = "color : white; font-weight: bold; font-size: larger;" class="underline"> List of Qualifying Exam: </span>\n\t
...
prescribed application fee by NTA. The candidate has to download the Admit Card from the NTA
website. The candidate will appear in the examination at the given Centre on the date and
shift/timing as indicated in his/her e-Admit Card. No candidate will be allowed to appear at the
examination Centre, on the date and shift/time other than that allotted to him/ her in his/ her
Admit Card.\n
...
// JEE Main Results
`<span style ="color : white;" class="underline""><a href="JEEmain.nta.nic.in" target="_blank" rel="noopener noreferrer">Click here</a> </span> to get JEE Main Result.`,
...
\ta):JOSAA (ispe clicke krne ke bad josaa wala page open hoga)\n
\tB:)CSAB (ispe click krne ke bad csab wala page open hoga)`
]
