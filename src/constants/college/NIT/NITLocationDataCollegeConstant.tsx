// this will store the location related data for all the NITs colleges 
...
export const NITWarangalLocationDataTableHeading = [
...
export const NITKarnatakaLocationDataTableHeading = [
...
export const NITTiruchirapalliLocationDataTableHeading = [
...
export const NITShibpurLocationDataTableConstant = [
    [
...
export const NITShibpurLocationDataTableHeading = [
