// this page consists of the constant page for the state engineering colleges 

import { IStateCollegeCard } from "../interfaces/interfaces";

export const StateCollegeCardConstants : Array<IStateCollegeCard> = [
    {
        collegeName : "State college BOMBAY", 
