        ...
        <div className="text-white  mt-10 w-full">
            ...
            <div className="flex justify-center items-center justify-evenly mt-10 w-full p-10">
                ...
                {ComedkCounsellingPageVideoCardUrlList.map((_ : string, index : number) => (
                    <VideoCard key={index} videoUrl={ComedkCounsellingPageVideoCardUrlList[index]} title={ComedkCounsellingPageVideoCardTitleList[index]} content="An example of a YouTube video embedded in a Tailwind CSS card."></VideoCard>
                ))}
            </div>
            <div className="">
