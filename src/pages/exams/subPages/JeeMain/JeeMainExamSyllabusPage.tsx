...
import { JeeMainSyllabusSubPageContentList, JeeMainSyllabusSubPageHeadingIdList, JeeMainSyllabusSubPageHeadingList, JeeMainSyllabusSubPageTableOfContentList } from "../../../../constants/exam/JeeMainsExamPageConstants"

const JeeMainExamSyllabusPage = () => {
    return (
        <div className="text-white  mt-10 w-full">
            ...
            <div className="">
                ...
                <BlogComponent headingIdList={JeeMainSyllabusSubPageHeadingIdList} headingNameList={JeeMainSyllabusSubPageHeadingList} tableOfContentsList={JeeMainSyllabusSubPageTableOfContentList} contentList={JeeMainSyllabusSubPageContentList}></BlogComponent>
...
export default JeeMainExamSyllabusPage