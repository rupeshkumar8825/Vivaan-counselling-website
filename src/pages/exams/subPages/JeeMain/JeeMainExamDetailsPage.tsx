...
import { JeeMainExamDetailsSubPageContentList, JeeMainExamDetailsSubPageHeadingIdList, JeeMainExamDetailsSubPageHeadingList, JeeMainExamDetailsSubPageTableOfContentList } from "../../../../constants/exam/JeeMainsExamPageConstants"

const JeeMainExamDetailsPage = () => {
    return (
        <div className="text-white  mt-10 w-full">
            ...
            <div className="">
                ...
                <BlogComponent headingIdList={JeeMainExamDetailsSubPageHeadingIdList} headingNameList={JeeMainExamDetailsSubPageHeadingList} tableOfContentsList={JeeMainExamDetailsSubPageTableOfContentList} contentList={JeeMainExamDetailsSubPageContentList}></BlogComponent>
...
export default JeeMainExamDetailsPage