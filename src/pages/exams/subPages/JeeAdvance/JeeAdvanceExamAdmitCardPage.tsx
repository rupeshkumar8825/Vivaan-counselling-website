...
import { JeeAdvanceAdmitCardContentList, JeeAdvanceAdmitCardHeadingIdList, JeeAdvanceAdmitCardHeadingList, JeeAdvanceAdmitCardTableOfContentList } from "../../../../constants/exam/JeeAdvanceExamPageConstants"

const JeeAdvanceExamAdmitCardPage = () => {
    return (
        <div className="text-white  mt-10 w-full">
            ...
            <div className="">
                ...
                <BlogComponent headingIdList={JeeAdvanceAdmitCardHeadingIdList} headingNameList={JeeAdvanceAdmitCardHeadingList} tableOfContentsList={JeeAdvanceAdmitCardTableOfContentList} contentList={JeeAdvanceAdmitCardContentList}></BlogComponent>
...
export default JeeAdvanceExamAdmitCardPage