...
import { JeeAdvanceDetailsContentList, JeeAdvanceDetailsHeadingIdList, JeeAdvanceDetailsHeadingList, JeeAdvanceDetailsTableOfContentList } from "../../../../constants/exam/JeeAdvanceExamPageConstants"

const JeeAdvanceExamDetailsPage = () => {
    return (
        <div className="text-white  mt-10 w-full">
            ...
            <div className="">
                ...
                <BlogComponent headingIdList={JeeAdvanceDetailsHeadingIdList} headingNameList={JeeAdvanceDetailsHeadingList} tableOfContentsList={JeeAdvanceDetailsTableOfContentList} contentList={JeeAdvanceDetailsContentList}></BlogComponent>
