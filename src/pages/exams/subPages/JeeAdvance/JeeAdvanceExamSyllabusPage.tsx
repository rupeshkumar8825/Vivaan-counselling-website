...
import { JeeAdvanceSyllabusContentList, JeeAdvanceSyllabusHeadingIdList, JeeAdvanceSyllabusHeadingList, JeeAdvanceSyllabusTableOfContentList } from "../../../../constants/exam/JeeAdvanceExamPageConstants"

const JeeAdvanceExamSyllabusPage = () => {
    return (
        <div className="text-white  mt-10 w-full">
            ...
            <div className="">
                ...
                <BlogComponent headingIdList={JeeAdvanceSyllabusHeadingIdList} headingNameList={JeeAdvanceSyllabusHeadingList} tableOfContentsList={JeeAdvanceSyllabusTableOfContentList} contentList={JeeAdvanceSyllabusContentList}></BlogComponent>
...
export default JeeAdvanceExamSyllabusPage