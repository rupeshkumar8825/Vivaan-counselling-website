...
import { JeeAdvanceEligibilityContentList, JeeAdvanceEligibilityHeadingIdList, JeeAdvanceEligibilityHeadingList, JeeAdvanceEligibilityTableOfContentList } from "../../../../constants/exam/JeeAdvanceExamPageConstants"

const JeeAdvanceExamEligibilityPage = () => {
    return (
        <div className="text-white  mt-10 w-full">
            ...
            <div className="">
                ...
                <BlogComponent headingIdList={JeeAdvanceEligibilityHeadingIdList} headingNameList={JeeAdvanceEligibilityHeadingList} tableOfContentsList={JeeAdvanceEligibilityTableOfContentList} contentList={JeeAdvanceEligibilityContentList}></BlogComponent>
...
export default JeeAdvanceExamEligibilityPage