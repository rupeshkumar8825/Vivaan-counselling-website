        ...
        <div className="text-white   w-full">
            ...
            <div className="flex  flex-col justify-around items-center md:flex-row  mt-10 w-full">
                ...
                {WbJEEVideoCardUrlList.map((_ : string, index : number) => (
                    <div className="mb-10">
                        <VideoCard key={index} videoUrl={WbJEEVideoCardUrlList[index]} title={WbJeeVideoCardTitleList[index]} content="An example of a YouTube video embedded in a Tailwind CSS card." videoCardWidth="64"></VideoCard>
